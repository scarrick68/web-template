...
describe("me page", () => {
  ...
  it("loads current user with stored Authorization bearer token", async () => {
    saveAuthTokens({ authorization: "Bearer jwt-token-1" });
    ...
    expect(receivedAuthorization).toBe("Bearer jwt-token-1");
  });
