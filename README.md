...
```sh
npm create vike@latest --- --react --tailwindcss --daisyui --eslint
```
...
- `VITE_API_BASE_URL`: Browser-visible absolute API base URL used by frontend fetch calls. Defaults to `http://localhost:5001`.
